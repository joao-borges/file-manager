 ...
 * @author JoãoGabriel
 */
@Component(value = OperationParamsBuilder.BEAN_NAME_FORMAT + OperationConstants.PHOTO_ORGANIZATION_OPERATION)
public class PhotoOrganizationParamsBuilder implements OperationParamsBuilder {
